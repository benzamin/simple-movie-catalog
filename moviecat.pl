...
my $copyright = "Copyright 2008-2015, $author";
...
sub format_movie
{
    ...
    print_html "<tr class=moviemeta><td height=1*><font size=1>";
    if (@tags) {
        print_html "Tags: <span class=MTAGS>", join(' ', @tags), "</span><br>";
    }

    print_html "<strong>Download: </strong>";
    my $i = 0;
...
sub page_start
{
    ...
    if ($opt_miss and $gname eq "Missing Info") {
        ...
        #print_html "</div>"; #This going to line 1607
...
sub page_end
{
    ...
    print_html "<br><div align=left><font size=-2><i>Generated by";
    print_html "<a href=https://github.com/benzamin/simple-movie-catalog>simple-movie-catalog</a> on $datestr</i></font></div>";
    print_html "<br><div align=right><font size=-2><i>original project ";
